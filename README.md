...
```
cd existing_repo
git remote add origin https://gitlab.com/xianbin.yong13/nus-library-proxy.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/xianbin.yong13/nus-library-proxy/-/settings/integrations)
